package com.faisal.kafkaRest.config;
...
public class SwaggerConfig {
	...
	public Docket eksadAPI() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.faisal.kafkaRest"))
				.paths(regex("/api.*"))
				.build()
			//	.apiInfo(metaInfo()
				.tags(
					new Tag("Producer","Producern Management API")
